            ...
            <div className='bg-[--card-bg] p-1 loginForm relative'>
                ...
                <div className='mt-4 p-4 flex flex-col gap-3'>
                    <div className='flex flex-col gap-1'>
                        ...
                        <input className='w-full rounded h-11 bg-transparent px-3' type='email' autoComplete='off' placeholder='Enter your email' name="email" id='email' value="" />
                    </div>
                    <div className='flex flex-col gap-1'>
                        <label className='text-[--label-color] text-sm font-medium' htmlFor='username'>Username</label>
                        <input className='w-full rounded h-11 bg-transparent px-3' type='text' autoComplete='off' placeholder='Choose a preferred username' name="username" id='username' value="" />
                    </div>
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='relative'>
                            <input className='w-full rounded h-11 bg-transparent px-3' type='password' autoComplete='off' placeholder='Choose a strong password' name="password" id='password' value="" />
                            <span className='cursor-pointer absolute right-3 bottom-3'><img width={20} height={20} src={eye} alt='eye' /></span>
                        </div>
                        <button className='bg-[--button-bg] h-11 text-white rounded mt-4 cursor-pointer text-base font-medium'>Continue</button>
                        <div className='mt-3'><span className='text-[--grey-color] text-sm font-medium text-center'>Already have an account?</span> <span className='text-white text-sm font-medium cursor-pointer' onClick={()=>{
