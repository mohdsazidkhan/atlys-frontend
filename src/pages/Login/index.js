            ...
            <div className='bg-[--card-bg] p-1 loginForm'>
              ...
              <div className='mt-4 p-4 flex flex-col gap-3'>
                ...
                <div className='flex flex-col gap-1'>
                  ...
                  <button className='bg-[--button-bg] h-11 text-white rounded mt-4 cursor-pointer text-base font-medium' onClick={()=>navigate('/home')}>Login Now</button>
                  <div className='mt-3'><span className='text-[--grey-color] text-sm font-medium text-center'>Not registered yet?</span> <span className='text-white text-sm font-medium'>Register →</span></div>
                </div>
              </div>
            </div>
          </div>
